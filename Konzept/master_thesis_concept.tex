...
\subsection{Szenarien} % (fold)
\label{sub:szenarien}

  Die Arbeiten von Carroll und Rossen \citep{five_reasons_for_scenario_based_design} und \citep{scenario_based_development} sollen Basis um das szenariobasierte Vorgehen bilden. Zwar kommen diese Arbeiten aus dem Bereich der Mensch-Computer Interaktion, lassen sich methodisch jedoch auch (in Teilen) auf andere Bereiche anwenden.

% subsection szenarien (end)
