...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for Transitions -->
    <!-- ======================================================================================== -->
    <xsl:template name="createTransitionContent" match="transition[@xsi:type='uml:Transition']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.Transition'"> </xsl:with-param>
        ...
        <!-- for future steps unique to UML transitions -->
    </xsl:template>
</xsl:stylesheet>
