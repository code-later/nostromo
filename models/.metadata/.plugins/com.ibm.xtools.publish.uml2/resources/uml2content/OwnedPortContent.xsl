...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for 'ownedPort' <tag>  -->
    <!-- ======================================================================================== -->
    <xsl:template name="createOwnedPortContent" match="ownedPort[@xsi:type='uml:Port']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.Port'"> </xsl:with-param>
        ...
        <!-- for future steps unique to UML Port -->
    </xsl:template>
</xsl:stylesheet>
