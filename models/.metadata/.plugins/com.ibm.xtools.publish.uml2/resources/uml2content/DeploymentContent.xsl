...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for <deployment> tag i.e. uml:Deployment -->
    <!-- ======================================================================================== -->
    <xsl:template name="createDeploymentContent" match="deployment[@xsi:type='uml:Deployment']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.Deployment'"> </xsl:with-param>
        ...
        <!-- for future steps unique to uml:Deployment -->
    </xsl:template>
</xsl:stylesheet>
