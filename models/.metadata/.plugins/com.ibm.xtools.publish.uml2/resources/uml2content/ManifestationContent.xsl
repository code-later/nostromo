...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for <manifestation> tag i.e. uml:Manifestation -->
    <!-- ======================================================================================== -->
    <xsl:template name="createManifestationContent" match="manifestation[@xsi:type='uml:Manifestation']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.Manifestation'"> </xsl:with-param>
        ...
        <!-- for future steps unique to uml:Manifestation -->
    </xsl:template>
</xsl:stylesheet>
