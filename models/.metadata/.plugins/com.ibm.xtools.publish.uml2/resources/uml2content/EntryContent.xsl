...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for Entry Activity -->
    <!-- ======================================================================================== -->
    <xsl:template name="createEntryContent" match="entry[@xsi:type='uml:Activity']" mode="createElementContent">
        ...
        <!-- for future steps unique to UML Entry Activity -->
    </xsl:template>
</xsl:stylesheet>
