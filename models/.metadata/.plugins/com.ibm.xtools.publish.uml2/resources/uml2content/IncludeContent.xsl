...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for <include> tag i.e. uml:Include -->
    <!-- ======================================================================================== -->
    <xsl:template name="createIncludeContent" match="include[@xsi:type='uml:Include']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.Include'"> </xsl:with-param>
        ...
        <!-- for future steps unique to uml:Include -->
    </xsl:template>
</xsl:stylesheet>
