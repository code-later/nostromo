...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for DeploymentSpecifications -->
    <!-- ======================================================================================== -->
    <xsl:template name="createConfigurationContent" match="configuration[@xsi:type='uml:DeploymentSpecification']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.DeploymentSpecification'"> </xsl:with-param>
        ...
        <!-- for future steps unique to UML DeploymentSpecification -->
    </xsl:template>
</xsl:stylesheet>
