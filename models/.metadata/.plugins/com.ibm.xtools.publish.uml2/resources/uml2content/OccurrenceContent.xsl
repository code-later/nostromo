...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for 'occurrence' <tag>  -->
    <!-- ======================================================================================== -->
    <xsl:template name="createOccurrenceContent" match="occurrence[@xsi:type='uml:CollaborationOccurrence']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.CollaborationOccurrence'"> </xsl:with-param>
        ...
        <!-- for future steps unique to UML CollaborationOccurrence -->
    </xsl:template>
</xsl:stylesheet>
