...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for Generalizations -->
    <!-- ======================================================================================== -->
    <xsl:template name="createGeneralizationContent" match="generalization[@xsi:type='uml:Generalization']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.Generalization'"> </xsl:with-param>
        ...
        <!-- for future steps unique to UML Generalizations -->
    </xsl:template>
</xsl:stylesheet>
