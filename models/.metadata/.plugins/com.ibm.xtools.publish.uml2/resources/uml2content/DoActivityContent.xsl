...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for 'doActivity' Activity -->
    <!-- ======================================================================================== -->
    <xsl:template name="createDoActivityContent" match="doActivity[@xsi:type='uml:Activity']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.Activity'"> </xsl:with-param>
        ...
        <!-- for future steps unique to UML 'doActivity' Activity -->
    </xsl:template>
</xsl:stylesheet>
