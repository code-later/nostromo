...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for <extend> tag i.e. uml:Extend -->
    <!-- ======================================================================================== -->
    <xsl:template name="createExtendContent" match="extend[@xsi:type='uml:Extend']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.Extend'"> </xsl:with-param>
        ...
        <!-- for future steps unique to uml:Extend -->
    </xsl:template>
</xsl:stylesheet>
