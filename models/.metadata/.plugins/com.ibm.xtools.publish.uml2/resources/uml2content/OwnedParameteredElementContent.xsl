...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <xsl:template name="ownedParameteredElementContent" match="ownedParameteredElement[@xsi:type='uml:Class']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.Class'"> </xsl:with-param>
        ...
        <!-- for future steps unique to UML ownedParameteredElements -->
    </xsl:template>
</xsl:stylesheet>
