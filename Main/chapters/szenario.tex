...
\label{cha:szenario}
  ...
  - Definition von Szenario (Oxford, Duden, Literatur)
  - Bei Rosson und Carrol: Story (auch definieren), also narrativ
...
% subsection methode_xy (end)

\subsection{Nicht geeignete Methoden} % (fold)
\label{sub:nicht_geeignete_methoden}

  - Diese Methoden sind nicht geeignet:
  
\subsubsection{SAAM} % (fold)
\label{ssub:saam}
...
% subsubsection saam (end)

% subsection nicht_geeignete_methoden (end)
