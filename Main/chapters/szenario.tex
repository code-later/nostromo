...
\subsection{Bekannte Methodiken} % (fold)
...
% subsection bekannte_methodiken (end)

\subsection{Methode für diese Arbeit} % (fold)
\label{sub:methode_fuer_diese_arbeit}

  - Was machen wir also in dieser Arbeit?
  - Zusammenfassen der Gründe.

% subsection methode_fuer_diese_arbeit (end)
