...
\label{sub:beschreibung_des_szenario}
  ...
  \begin{kasten}
    \minisec{Narrative Beschreibung der Situation} % (fold)
    ...
    % minisec narrative_beschreibung_der_situation (end)
