...
% subsubsection speichern_und_laden_von_medienobjekten (end)
  ...
  \lstinputlisting[caption=\texttt{MusicOMat}-Klasse unter Verwendung von dem Medienobjekt,label=lst:music_o_mat_with_media_object,language=Java,firstline=25,lastline=41,morekeywords={[3]MediaComponent,getBroker,Media}]{../code/Santiago/src/main/java/de/fhkoeln/santiago/codesamples/MusicOMatWithMediaObject.java}
