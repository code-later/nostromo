...
//        inputFiles.addElement(args[i]);
        inputFiles.addAll(getFilesInDirectory(args[i]));
      }
      i++;
    }
   ...
   * @return
   */
  private static List getFilesInDirectory(String pathToDirectory) {
    ...
    List pathnames = new ArrayList<String>();
  ...
  class ImageDataSource extends PullBufferDataSource {
    ...
    /**
     * We could have derived the duration from the number of frames
     * and frame rate. But for the purpose of this program, it's not
     * necessary.
     */
...
//       Format.NOT_SPECIFIED);
    ...
    /**
     * This is called from the Processor to read a frame worth of
     * video data.
     */
