...
public class MemcachedServiceRegistry implements ServiceRegistry {
  ...
  /* (non-Javadoc)
   * @see de.fhkoeln.santiago.services.registry.ServiceRegistry#publish(de.fhkoeln.santiago.services.CoreService)
   */
  ...
  /* (non-Javadoc)
   * @see de.fhkoeln.santiago.services.registry.ServiceRegistry#query(java.lang.String)
   */
