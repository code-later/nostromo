...
public class MapProcessStoreImpl implements ProcessStore {
  ...
  /* (non-Javadoc)
   * @see de.fhkoeln.cosima.workflow.storage.ProcessStore#getInputByKey(java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see de.fhkoeln.cosima.workflow.storage.ProcessStore#putDataForKey(java.lang.String, java.lang.String)
   */
